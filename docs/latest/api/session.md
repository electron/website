...
* `handler` Function\<Boolean&#62; | null
  * `details` Object
    ...
    * `device` [HIDDevice](latest/api/structures/hid-device.md) - the device that permission is being requested for.
...
unlike [`webContents.downloadURL`](latest/api/web-contents.md#contentsdownloadurlurl).
