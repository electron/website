---
title: "Native Code and Electron: C++ (Windows)"
description: "This tutorial builds on the general introduction to Native Code and Electron and focuses on creating a native addon for Windows using C++ and the Win32 API. To illustrate how you can embed native Win32 code in your Electron app, we'll be building a basic native Windows GUI (using the Windows Common Controls) that communicates with Electron's JavaScript."
slug: native-code-and-electron-cpp-win32
hide_title: false
---
