...
- Added support to import external shared texture as [VideoFrame](https://developer.mozilla.org/en-US/docs/Web/API/VideoFrame). [#47317](https://github.com/electron/electron/pull/47317) <sup>(Also in [40](https://github.com/electron/electron/pull/48831))</sup>
